...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { complete: @todo_item.complete, deadline: @todo_item.deadline, description: @todo_item.description, priority: @todo_item.priority }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { complete: @todo_item.complete, deadline: @todo_item.deadline, description: @todo_item.description, priority: @todo_item.priority }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
